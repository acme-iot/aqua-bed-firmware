...
String FileSystem::read_file(const char * path){
...
String FileSystem::readWholeFile(fs::FS &fs, const char * path)
{
...
int FileSystem::deleteFileWithPrefix(const char * _Prefix)
{
    int count = 0;
